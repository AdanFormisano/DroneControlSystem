...
std::chrono::milliseconds tick_duration_ms = std::chrono::milliseconds(400);    // duration of 1 tick in milliseconds. 50ms is minimum I could set without the simulation breaking
